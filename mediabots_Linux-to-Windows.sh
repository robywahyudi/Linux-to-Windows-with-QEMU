...
link1_status=$(curl -Is https://ia803103.us.archive.org/11/items/win101909virtio/Win10-1909Virtio.iso | grep HTTP | cut -f2 -d" " | head -1)
link2_status=$(curl -Is https://ia803103.us.archive.org/11/items/win101909virtio/Win10-1909Virtio.iso | grep HTTP | cut -f2 -d" ")
#sudo wget -P /mediabots https://archive.org/download/WS2012R2/WS2012R2.ISO # Windows Server 2012 R2 
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/Win10-1909Virtio.iso https://ia803103.us.archive.org/11/items/win101909virtio/Win10-1909Virtio.iso
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://ia803103.us.archive.org/11/items/win101909virtio/Win10-1909Virtio.iso
else
